...
import { Header, StyledSection } from "../../Styles/AboutStyle";
...
const About = () => {
    ...
    return(
        <div>
        <Navbar/>
        <Card style={{boxShadow: "none", paddingTop: "17%"}}>
        ...
        <StyledSection id="history">
            ...
            <img src={img4} style={{width: "500px"}} alt=""/>
            <p>
        ...
        <section id="charities-aid-foundation">
