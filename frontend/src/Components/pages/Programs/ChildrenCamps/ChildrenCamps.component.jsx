...
const campsData = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        description: "Lots of fun activities which brought everyone together",
        imageURL:
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        highlightTitle: "Introduction to Adivasi Munnetra Sangam and VBVT",
        description: "",
        imageURL:
          "http://www.vidyodaya.org/vbvt/wp-content/uploads/2018/01/camp-2-1024x576.jpg",
      },
      {
        highlightTitle: "Visits to Adivasi hospital and Just Change Soap Unit.",
        description: "",
        imageURL: "",
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        description: "A sport that is enjoyed by both boys and the girls",
        imageURL:
    ...
    feedback: [
      ...
      {
        testimonial: "We got some ideas to tackle the problem of alcoholism",
        source: "",
      },
      {
        testimonial: "I have got one more family and will keep in touch.",
        source: "",
      },
      {
    ...
    <Container>
      ...
      <ChildrenCampsContainer>
        <div className="children-camps-inner-container">
          <p>
            Camps are held over weekends or during the term holidays. Teenage
            children come to a particular center and take part in multiple
            activities ranging from computer classes to games to cultural
            activities. Although most of these activities are planned so that
            the children get to learn what they would otherwise not learn at
            school, a lot of other inputs get included in a very unobtrusive
            way.
            <br />
            <br />
            We have heard from many of the youth that their decision to go on
            for higher studies or get involved with the Sangam activities has
            been largely due to the influence of the camps they had attended.
            <br />
            <br />
            They mentioned that at the camps the ideas discussed the questions
            raised and the challenges they would face in future, had all
            contributed to the direction and the decisions they had made.
            <br />
            <br />
            The trust thus believes that the youth have to build their future
            and that camps play a significant role in shaping their future.
            <br />
            <br />
          ...
          <div className="camp-buttons-container">
            {campsData.map((camp) => {
              return (
                ...
                >
                  <h3 className="children-camps-btn-h3">{camp.title}</h3>
