  ...
  return (
    <MainContainer>
      <Switch>
        ...
        <Route
          exact
          path="/programs/education-program/childrens-bank"
          component={ChildrensBank}
        />
        <Route
          exact
          path="/programs/education-program/study-centers"
          component={StudyCenters}
        />
        <Route
          exact
          path="/programs/education-program/scholarships"
          component={Scholarships}
        />
        <Route
          exact
          path="/programs/education-program/skills-upgradation"
          component={SkillsUpgradation}
        />
        <Route
          exact
          path="/programs/education-program/teacher-training-2014"
          component={TeacherTraining2014}
        />
        <Route
          exact
          path="/programs/education-program/teacher-training-2012"
          component={TeacherTraining2012}
        />
        <Route
          exact
