				...
				<div className="education-program-inner-container">
					<TextContainer>
                        ...
                        <ul style={{margin: "2% 10%"}}>
                            ...
                            <li>Teach in Centres for drop-out children and help them join the mainstream schools.</li>
                            <li>To make parents aware of educational needs, their child’s learning levels, and advice them about the best options for their child</li>
                        </ul>
						<p>
                        ...
                        <br/>
						<h3 id="higher-education">The process of their end of term Assessment:</h3>
                        <br/>
                        <p>
