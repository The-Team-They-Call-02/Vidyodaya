...
const SkillsUpgradation = (props) => {
	...
	return (
		<Container>
			<HeadingContainer>
				<Heading id="education-program">Skills Upgradation Training Jan'15 to Dec'15</Heading>
