                ...
                <Container id="history">
                    ...
                    <TextContainer>
                        ...
                        <ul>
                            ...
                            <li>Some aspects of the Adivasi culture included in the curriculum</li>
                            <li>Assessments not based only on performance in the examinations or tests, but based on a holistic approach</li>
                        </ul>
                        </TextContainer>
                        <TextContainer>
                        <p>
