...
// styled-components
import { FooterStyle, H2Styled, PStyled, Links, Social, Icons } from "../../Styles/FooterStyle";
...
const Footer = () => {
    ...
    return(
        ...
        <Links>
            ...
            <HashLink smooth to="/about/managing-committee" scroll={el => scrollWithOffset(el)}><PStyled>Managing Committees</PStyled></HashLink>
            ...
            <HashLink smooth to="/reports/annual" scroll={el => scrollWithOffset(el)}><PStyled>Annual Reports</PStyled></HashLink>
            <HashLink smooth to="/reports/financial" scroll={el => scrollWithOffset(el)}><PStyled>Financial Reports</PStyled></HashLink>
            <HashLink smooth to="/reports/other" scroll={el => scrollWithOffset(el)}><PStyled>Other Reports</PStyled></HashLink>
            </div>
            <div style={{padding: "2%"}}>
            <NavLink to="/programs"><H2Styled>Programs</H2Styled></NavLink>
            <NavLink to="/programs/frisbee-program"><PStyled>Ultimate Frisbee Program</PStyled></NavLink>
            <NavLink to="/programs/children-camps"><PStyled>Children Camps</PStyled></NavLink>
            <NavLink to="/programs/education-program"><PStyled>Education Programs</PStyled></NavLink>
        ...
        <Social>
            ...
            <Icons>
                ...
                <a href="https://www.youtube.com/user/VidyodayaGudalur" target="_blank">
