...
import com.opportunity.hack.repository.VolunteerRepository;
...
public class VolunteerServiceImpl implements VolunteerService {
    ...
    public Volunteer findVolunteerById(long id) {
        return volunteerrepos.findById(id).orElseThrow(() -> new EntityNotFoundException("Volunteer Id not Found"));
    }
    ...
    public Volunteer save(Volunteer volunteer) {
        ...
        if (volunteer.getVolunteerid() != 0) {
            volunteerrepos.findById(volunteer.getVolunteerid()).orElseThrow(() -> new EntityNotFoundException("Id invalid"));
    ...
    public void delete(long id) {
        volunteerrepos.findById(id).orElseThrow(() -> new EntityNotFoundException("Volunteer id " + id + " Not Found!"));
